...
import com.example.dairyfarm.databinding.ActivityCheeseBinding;
...
ActivityCheeseBinding binding;
    int qty;
    int cheeseqty=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        binding= ActivityCheeseBinding.inflate(getLayoutInflater());
        super.onCreate(savedInstanceState);
        setContentView(binding.getRoot());

        binding.imageView3.setImageResource(R.drawable.cheese);
        ...
        binding.minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (qty==0){
                    Toast.makeText(Cheese.this, "Quantity cannot be less than '0'", Toast.LENGTH_SHORT).show();
                }
                else if(qty>0){
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                cheeseqty= (Integer.parseInt(binding.editquantity.getText().toString()));
                Data data=Data.getInstance();
                data.setCheeseqt(cheeseqty);
